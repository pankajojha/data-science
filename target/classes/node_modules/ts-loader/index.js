...
function ensureTypeScriptInstance(loaderOptions, loader) {
    ...
    if (configFilePath) {
        ...
        var configFile = compiler.readConfigFile(configFilePath, function (filePath) { return fs.readFileSync(filePath, 'utf-8'); });
        if (configFile.error) {
            ...
            for (var _i = 0; _i < moduleNames.length; _i++) {
                ...
                if (tsResolution.resolvedModule) {
                    ...
                    if (resolvedFileName)
                        ...
                        resolutionResult = tsResolution.resolvedFileName;
                }
    ...
    loader._compiler.plugin("after-compile", function (compilation, callback) {
        ...
        pushArray(compilation.errors, formatErrors(compilerOptionDiagnostics, instance, { file: configFilePath || 'tsconfig.json' }));

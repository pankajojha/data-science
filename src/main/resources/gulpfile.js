...
gulp.task('build.css.dev', function () {
  return gulp.src(PATH.src.css).pipe(gulp.dest(PATH.dest.dev.css));
});
...
gulp.task('dev', ['build.dev', 'livereload'], function () {
...
gulp.task('prod', ['build.prod', 'livereload'], function () {
  watch(join(PATH.src.all, '**'), function (e) {
